                            ...
                            <div class="container">
                                ...
                                <input type="text" name="name" id="name" placeholder="Your Name" />--%>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:RequiredFieldValidator ID="StudentNameRequired" runat="server" ControlToValidate="StudentName" ErrorMessage="Student Name is required." ToolTip="Student Name is required." ValidationGroup="CreateUserWizard1">
                                                  *</asp:RequiredFieldValidator>
